...
var copyPath = ["src/**/!(_)*.*", "!src/**/*.scss", "!src/**/*.ts"];
var sassPath = ["src/**/*.scss", "src/app.scss"];
var watchSassPath = ["src/**/*.scss", "src/css/**/*.scss", "src/app.scss"];
...
gulp.task("watch", () => {
  ...
  gulp.watch(watchSassPath, gulp.series("sass")); //Change
